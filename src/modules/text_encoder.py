...
def encode_prompts(pipeline_components, positive_prompt, negative_prompt=None, 
    ...
    print(f"pos_embeds_1 shape: {pos_embeds_1.shape}")
    print(f"pos_embeds_2.last_hidden_state shape: {pos_embeds_2.last_hidden_state.shape}")
    print(f"Expected total: should be 2048 dims")
    ...
    print(f"Final negative embeds shape: {negative_embeds.shape}")
    print(f"Pooled positive shape: {pooled_positive.shape}")
